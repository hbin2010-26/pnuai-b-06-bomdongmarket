...
|      단계      |           방식            | 적용 내용                                                                                                                                                                      |
| :------------: | :-----------------------: | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|    TDD·리뷰    |  Claude Code Superpowers  | 실패 테스트 작성, 최소 구현, 전체 검증 순으로 개발. superpowers reviewer로 PR 변경 범위와 회귀 위험 검토                                                                       |
|   병렬 개발    |         SubAgent          | 작업 단위별 Agent를 병렬로 운용하고 각 Agent가 읽을 참조 문서와 소유 범위를 지정                                                                                               |
