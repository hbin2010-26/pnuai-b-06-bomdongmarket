...
public record ProfitEstimateResponse(
        ...
        @Schema(description = "월 양액 사용량(L)", example = "18121") long nutrientSolutionL,
        @Schema(description = "예상 월 양액비(KRW)", example = "362419") long nutrientCostKrw,
        @Schema(description = "예상 월 재료비 합계(KRW) = 모종비 + 양액비", example = "1220419") long materialCostKrw,
